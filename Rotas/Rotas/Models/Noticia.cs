...
namespace Rotas.Models
{
    public class Noticia
    {
        ...
        public IEnumerable<Noticia> TodasAsNoticias() //cria um função com retorno do tipo enumerable do próprio tipo (Noticia)
        {
            var retorno = new Collection<Noticia> //cria uma variável retorno do tipo collection de notícia
                {
                    new Noticia
                        {
                            NoticiaId = 1,

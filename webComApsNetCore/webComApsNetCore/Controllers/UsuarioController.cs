...
namespace webComApsNetCore.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,NoUsuario,CPF,Telefone,CEP,CNPJ,UsuDatNasc")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("UsuarioId,NoUsuario,CPF,Telefone,CEP,CNPJ,UsuDatNasc")] Usuario usuario)
        {
